...
int main() {
	...
	*numComps = 0;
	...
	printf("O vetor foi criado e será ordenado. Descomente printArray(vetorTeste, size) na linha 31 para visualizar.\n");
	...
	*numComps = 0;
	...
	if (posValSearch == -1)
		...
		printf("%d está no vetor, pos: %d\n\n", valSearch, posValSearch);
	printf("O vetor foi ordenado. Descomente printArray(vetorTeste, size) na linha 85 para visualizar.\n");
	// printArray(vetorTeste, size);
	free(vetorTeste);
	free(numComps);
	vetorTeste = NULL;
