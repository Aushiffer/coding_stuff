...
int main() {
	...
	struct pessoa *c4 = criaPessoa('D', rand() % 2, rand() % 2, rand() % 2, rand() % 2, rand() % 2, rand() % 2);
	struct pessoa *c5 = criaPessoa('E', rand() % 2, rand() % 2, rand() % 2, rand() % 2, rand() % 2, rand() % 2);
	struct pessoa *c6 = criaPessoa('F', rand() % 2, rand() % 2, rand() % 2, rand() % 2, rand() % 2, rand() % 2);
	struct pessoa *c7 = criaPessoa('G', rand() % 2, rand() % 2, rand() % 2, rand() % 2, rand() % 2, rand() % 2);
	...
	struct pessoa *p5 = criaPessoa('~', rand() % 2, rand() % 2, rand() % 2, rand() % 2, rand() % 2, rand() % 2);
	...
	push(pilhaCandidatos, c7);
	push(pilhaCandidatos, c6);
	push(pilhaCandidatos, c5);
	push(pilhaCandidatos, c4);
